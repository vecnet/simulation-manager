...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Simulation.id_on_client'
        db.add_column(u'sim_manager_simulation', 'id_on_client',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Simulation.id_on_client'
        db.delete_column(u'sim_manager_simulation', 'id_on_client')
    ...
    models = {
        ...
        u'sim_manager.simulation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_on_client': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'}),
