...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Simulation.batch_job_id'
        db.add_column(u'sim_manager_simulation', 'batch_job_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Simulation.batch_job_id'
        db.delete_column(u'sim_manager_simulation', 'batch_job_id')
