...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Simulation.batch_job'
        db.delete_column(u'sim_manager_simulation', 'batch_job')


    def backwards(self, orm):
        # Adding field 'Simulation.batch_job'
        db.add_column(u'sim_manager_simulation', 'batch_job',
