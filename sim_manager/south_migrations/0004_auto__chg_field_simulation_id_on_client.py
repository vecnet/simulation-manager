...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Simulation.id_on_client'
        db.alter_column(u'sim_manager_simulation', 'id_on_client', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Simulation.id_on_client'
        db.alter_column(u'sim_manager_simulation', 'id_on_client', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'sim_manager.simulation': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'ready'", 'max_length': '6'})
        },
