...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Simulation.status'
        db.add_column(u'sim_manager_simulation', 'status',
                      self.gf('django.db.models.fields.CharField')(default='ready', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Simulation.status'
        db.delete_column(u'sim_manager_simulation', 'status')
