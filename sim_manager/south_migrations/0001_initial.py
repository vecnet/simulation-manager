...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SimulationGroup'
        db.create_table(u'sim_manager_simulationgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('submitter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('submitted_when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('process_id', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('script_status', self.gf('django.db.models.fields.CharField')(default='ready', max_length=6)),
            ('script_error', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'sim_manager', ['SimulationGroup'])

        # Adding model 'Simulation'
        db.create_table(u'sim_manager_simulation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sim_manager.SimulationGroup'])),
            ('batch_job', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ))
        db.send_create_signal(u'sim_manager', ['Simulation'])


    def backwards(self, orm):
        # Deleting model 'SimulationGroup'
        db.delete_table(u'sim_manager_simulationgroup')

        # Deleting model 'Simulation'
        db.delete_table(u'sim_manager_simulation')
