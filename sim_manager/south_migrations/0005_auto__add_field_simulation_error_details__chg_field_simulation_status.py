...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Simulation.error_details'
        db.add_column(u'sim_manager_simulation', 'error_details',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)


        # Changing field 'Simulation.status'
        db.alter_column(u'sim_manager_simulation', 'status', self.gf('django.db.models.fields.CharField')(max_length=7))

    def backwards(self, orm):
        # Deleting field 'Simulation.error_details'
        db.delete_column(u'sim_manager_simulation', 'error_details')


        # Changing field 'Simulation.status'
        db.alter_column(u'sim_manager_simulation', 'status', self.gf('django.db.models.fields.CharField')(max_length=6))
